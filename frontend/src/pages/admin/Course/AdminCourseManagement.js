        ...
        if (response.data.success) {
          ...
          try {
            ...
            if (instructorsResponse.data.success) {
              // Filter instructors to match course department
              const departmentInstructors = instructorsResponse.data.data.filter(
                instructor => instructor.department === course.department
              );
          ...
          try {
            ...
            if (tasResponse.data.success) {
              // Filter TAs to match course department
              const departmentTAs = tasResponse.data.data.filter(
                ta => ta.department === course.department
              );
