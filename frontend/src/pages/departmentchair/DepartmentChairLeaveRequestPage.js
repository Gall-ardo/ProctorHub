...
import './DepartmentChairLeaveRequestPage.css';
import DepartmentChairNavBar from './DepartmentChairNavBar';

function DepartmentChairLeaveRequestPage() {
    ...
    return (
        <div className="departmentchair-leave-page">
            {/* Use the existing DepartmentChairNavBar component */}
...
export default DepartmentChairLeaveRequestPage;