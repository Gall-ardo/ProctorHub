const examService  = require('../../services/Dean/examService');
...
class ExamController {
    ...
    async assignProctors(req, res) {
        try {
            ...
            const result = await examService.assignProctors({
                ...
                departments: departments || ['CS', 'EEE', 'ME', 'IE']
            });
    ...
    async getCourses(req, res) {
        try {
          ...
          const { department = null, semesterId = null } = req.query;
    
          // call your service
          const courses = await examService.getCourses(department, semesterId);
